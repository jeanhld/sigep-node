...
const imgLogo = require('../assets/img/correios-logo.png');
...
class PrintPDF {
    ...
    async _buildHTMLTags() {
        ...
        logo_correios = Buffer.from( /*logo_correios*/ imgLogo ).toString('base64')
    ...
    async tagsToPDF( pathOut ) {
        ...
        const response = await this.createPDF(html, options);
